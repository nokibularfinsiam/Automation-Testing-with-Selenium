const { Builder, Browser, By, Key, until } = require('selenium-webdriver')
    ...
    ; (async function example() {
        ...
        try {
            ...
            await driver.findElement(By.name('email')).sendKeys('abc@gmail.com', Key.RETURN)
            ...
            await driver.wait(until.titleIs('AAMRA | LOGIN'), 10000)
        } finally {
            await driver.quit()
        }
    })()
...
describe("AAMRA website TEST", function () {
    it("Check Signup", function () {
        console.log("Signup Test: Fail")
        throw Error("Test Failed: The provided email is already registered!")
    })
})